...
g.state.keybinds = {
    {'GAMEPAD_DPAD_RIGHT',  'down_dir_gamepad',     movement.down_dir},
    {'GAMEPAD_DPAD_LEFT',   'up_dir_gamepad',       movement.up_dir},
    {'GAMEPAD_DPAD_DOWN',   'scroll_down_gamepad',  function() cursor.scroll(1, o.wrap) end, {repeatable = true}},
    {'GAMEPAD_DPAD_UP',     'scroll_up_gamepad',    function() cursor.scroll(-1, o.wrap) end,   {repeatable = true}},
    {'GAMEPAD_ACTION_DOWN', 'play_gamepad',         function() playlist.add_files('replace', false) end},
    {'GAMEPAD_ACTION_LEFT', 'play_append_gamepad',  function() playlist.add_files('append-play', false) end},
    {'GAMEPAD_ACTION_UP',   'play_autoload_gamepad',function() playlist.add_files('replace', true) end},
    {'GAMEPAD_ACTION_RIGHT','select_item_gamepad',  cursor.toggle_selection},
